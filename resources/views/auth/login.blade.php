...
@section('content')
    <div class="showcase">
        <div class="video-container">
            <video src="{{ asset('images/beatrate.mp4') }}" autoplay muted loop id="myVideo"></video>
        </div>
    </div>
                        ...
                        <form method="POST" action="{{ route('login_submit') }}">
                                ...
                                <div>
                                    <svg class="mySVG" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g class="earR">
                                            ...
                                            <g class="earHair">
                                                <rect x="131" y="64" fill="#FFFFFF" width="20"
                                                    height="35" />
                                                <path
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="email"
                                    class="email form-control @error('email') is-invalid @enderror" maxlength="256"
