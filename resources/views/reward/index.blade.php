                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header text-center mb-3 justify-content-between">
                                    <h4>All Rewards</h4>
                                    <div>
                                        <a href="{{ route('reward.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
                                    </div>
                                </div>
                                    ...
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        <tbody>
                                            @forelse ($rewards as $item)
                                                <tr>
                                                    <td>{{ $loop->index + 1 }}</td>
                                                    <td><img src="{{ url('/images/reward/' . $item->image) }}" alt="image"
                                                            width="50" height="50"></td>
                                                    <td>{{ $item->title }}</td>
                                                    <td>{{ $item->point }}</td>
                                                    <td>
                                                        <a href="{{ route('reward.edit', $item->id) }}"><button
