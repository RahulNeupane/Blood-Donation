...
@section('content')
                ...
                <div class="col-lg-12 align-content-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="single-team">
                                <div class="img-area">
                                    <img src="{{ url(asset('images/imgg.jpg')) }}" class="img-responsive" alt=""
                                        height="435px">
                                    <div class="social">
                                        <ul class="list-inline">
                                            <li><a href="#"><i class='bx bxl-facebook-circle'></i></a></li>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            @forelse ($blogs as $blog)
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card blogg mb-5 shadow-sm">
                        <img src="{{ url('/images/gallery/' . $blog->image) }}" class="img-responsive" alt=""
                            height="435px">
                        <div class="card-body">
            ...
            @empty
                <h3 class="text-center text-capitalize">no current blogs</h3>
            @endforelse
        </div>
    </div>
    <!-- contact section  -->
