            ...
            <div class="row">
                <div class="col-lg-8 col-sm-10 col-md-8 mx-auto">
                    ...
                    <div class="card card-primary">
                        ...
                        @endif
                        <div class="card-body ">
                            <form method="POST" action="{{ route('requestSubmit') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group ">
                                            ...
                                            <input id="name" type="name"
                                                class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter full name"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group ">
                                            <img src="{{ url(asset('images/requestIcons/telephone-fill.svg')) }}" alt="">
                                            <label style="color:#C70039" class="fw-bold">Phone Number</label>
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror" placeholder="Your contact number"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group ">
                                            <img src="{{ url(asset('images/requestIcons/envelope-fill.svg')) }}" alt="">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group ">
                                            <img src="{{ url(asset('images//requestIcons/droplet-half.svg')) }}" alt=""> 
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <img src="{{ url(asset('images//requestIcons/file-richtext.svg')) }}" alt="">                                          
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group ">
                                            ...
                                            <label for="message" class="form-label fw-bold" style="color:#C70039" >Note</label>
